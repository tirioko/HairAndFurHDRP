...
void MotionVectorPositionZBias(VaryingsToDS input)
{
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////TODO  CHNAGE THIS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! It was in clipspace
#if defined(UNITY_REVERSED_Z)
    input.vmesh.positionRWS.z -= unity_MotionVectorsParams.z * input.vmesh.positionRWS.z;
#else
    input.vmesh.positionRWS.z += unity_MotionVectorsParams.z * input.vmesh.positionRWS.z;
#endif
}
...
#endif
	varyingsType.vpass.positionCS = float4( normalWS.xyzz);
	varyingsType.vpass.previousPositionCS = float4(previousPositionRWS.x, previousPositionRWS.y, previousPositionRWS.z, previousPositionRWS.z);//  float4(previousPositionRWS.x, previousPositionRWS.y, 0, previousPositionRWS.z) ;
...
#endif 
		varyingsType.vpass.previousPositionCS = float4(inputPass.previousPositionOS;//mul(UNITY_MATRIX_PREV_VP, float4(previousPositionRWS, 1.0));
    }
	*/

	//PackedVaryingsType vtout= PackVaryingsType(varyingsType);
	//vtout.vpass.interpolators1 = varyingsType.vmesh.positionRWS.xyz;
