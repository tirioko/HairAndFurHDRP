//Shader for making hairs using tesselation and geometry shader. Based on Unity LitTesselation shader
...
Shader "HairHDRP"
{
  ...
  // #define HAVE_TESSELLATION_MODIFICATION
    ...
    #include "LitPropertiesHair.hlsl"
//#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitProperties.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "LitDataHair.hlsl"

            #include "ShaderPassGBufferHair.hlsl"
			#include "TessellationShareHair.hlsl" 
			#include "VertHair.hlsl"
            #include "HairGeometry.hlsl"		
          
            #pragma vertex VertC
			#pragma hull HullHair
            #pragma domain DomainHair
			#pragma geometry HairGeometry
            #pragma fragment FragHair          
        ...
        Pass
        {
            ...
            #include  "LitHair.hlsl"
            #include "LitDepthPassHair.hlsl"
            #include "LitDataHair.hlsl"
            #include "ShaderPassDepthOnlyHair.hlsl"
            #include "TessellationShareHair.hlsl"
            #include "HairGeometry.hlsl"		
        ...
        Pass
        {
           ...
           // #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl" 
            //#else			
            #include "LitMotionVectorPassHair.hlsl"
          //  #endif
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
            #include "ShaderPassMotionVectorsHair.hlsl"
			#include "TessellationShareHair.hlsl"  
			#include "HairGeometry.hlsl"		
